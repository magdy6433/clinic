        ...
        <div class="container">
            ...
            <?php foreach($data_doctor as $doctor): ?>
                <div class="details d-flex gap-2 align-items-center">
                    <img src="../../admin/controller/doctors/<?php echo $doctor['image']; ?>" alt="doctor" class="img-fluid rounded-circle" height="150"
                        width="150">
                    <div class="details-info d-flex flex-column gap-3 ">
                        <h4 class="card-title fw-bold"><?php echo "doctor ". $doctor['name'] ?></h4>
                ...
                <form class="form" method="POST" action="../controller/booking.php">
