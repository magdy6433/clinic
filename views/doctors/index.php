...
if ($major_id !== null) {
    $sql_doctor .= ' WHERE doctors.major_id = ' . $major_id;
}
...
<head>
    ...
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.1/css/bootstrap.rtl.min.css"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" /> -->
    <link rel="stylesheet" href="../../design/front/assets//styles/pages/main.css">
        ...
        <nav class="navbar navbar-expand-lg navbar-expand-md bg-blue sticky-top">
            <div class="container">
                <div class="navbar-brand">
                    <a class="fw-bold text-white m-0 text-decoration-none h3" href="../index.php" index.html">VCare</a>
                </div>
        ...
        <div class="container">
            ...
            <?php foreach($data_doctor as $doctor): ?>
                <div class="card p-2" style="width: 18rem;">
                    <img src="../../admin/controller/doctors/<?php echo $doctor['image']; ?>" class="card-img-top rounded-circle card-image-circle"
                        alt="major">
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        <h4 class="card-title fw-bold text-center"><?php echo $doctor['name']; ?></h4>
                        <h6 class="card-title fw-bold text-center"><?php echo $doctor['major_title']; ?></h6>
                        <a href="doctor.php?doctor_id=<?php echo $doctor['id']; ?>" doctor.html" class="btn btn-outline-primary card-button">Book an
                            appointment</a>
                    </div>
                </div>
               <?php endforeach; ?>
